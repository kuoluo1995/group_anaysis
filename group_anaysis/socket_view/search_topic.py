...
class SearchTopicsByPersonIds(WebsocketConsumer):
    def connect(self):
        self.accept()
    ...
    def receive(self, text_data):
        ...
        if 'person_ids[]' in request and request['person_ids[]'] and 'populate_ratio' in request and request[
            ...
            try:
                ...
                _name = 'error_search_topic_' + str(datetime.datetime.now()).replace(' ', '-').replace(':', '_')
